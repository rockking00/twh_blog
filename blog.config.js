...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'twh', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '仙人抚我顶，结发授长生🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://twh-blog.vercel.app/', // 网站地址
